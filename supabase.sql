...
create table if not exists public.test_results (
  ...
  assessment_version text not null default '3.2.0' check (char_length(assessment_version) between 1 and 20),
...
alter table public.test_results add column if not exists assessment_version text not null default '3.2.0';
...
alter table public.test_results alter column assessment_version set default '3.2.0';
