window.EXTRA_QUESTIONS = (() => {
  ...
  return [
    Q("出发之前", "证件提醒", "出发前三天，有人还没确认签证和证件。你会？", [
      ...
      O("直接说这是个人责任，出问题不要拖累全队", ["ning","yang"], {boundary:2, confrontation:2}),
      O("相信大家会处理好，不想提前制造紧张", ["chen","xu"], {boundary:1, stability:1, initiative:-1})]),
    ...
    Q("出发之前", "保险选择", "有人觉得旅行保险浪费钱，有人坚持必须买。你会？", [
      O("列出风险与赔付范围，再让大家共同决定", ["jing","yang"], {stability:2, boundary:1, devotion:1}),
      O("我会买自己的，别人怎么选由别人负责", ["ning","chen"], {boundary:2, confrontation:1}),
      O("倾向都买，少一点预算也比出事后慌乱好", ["zheng","mao"], {stability:1, devotion:2}),
      O("如果大家都不想买，我也不想扫兴", ["xu","mao"], {expression:1, confrontation:-1, boundary:-1})]),
    ...
    Q("出发之前", "叫早安排", "有人睡得很沉，却要求全队负责叫醒。你会？", [
      ...
      O("我会担心误车，可能整晚都惦记着叫人", ["zheng","xu"], {devotion:2, stability:-2}),
    ...
    Q("路上协作", "导航争议", "你和同伴的导航给出完全不同的路线。你会？", [
      O("停下来核对路标和实时交通，再统一路线", ["jing","yang"], {stability:2, initiative:1}),
      O("选一条先走，错了再调整，别原地争论", ["chen","ning"], {initiative:2, confrontation:1}),
      O("让更熟悉当地的人决定，我负责配合", ["mao","zheng"], {devotion:1, stability:1}),
      O("会在意对方是否总是否定我，而不只是路线", ["xu","zheng"], {expression:2, stability:-1})]),
    ...
    Q("路上协作", "饮食差异", "有人忌口很多，选餐厅总是难以统一。你会？", [
      O("先列硬性忌口，再找所有人都能接受的店", ["jing","yang"], {devotion:2, stability:2}),
    ...
    Q("路上协作", "拍照节奏", "有人每到一处都要拍很久，团队进度不断被打断。你会？", [
      ...
      O("如果大家开心，多停一会儿也没关系", ["xu","mao"], {expression:1, stability:1, boundary:-1})]),
    Q("路上协作", "账单分摊", "一顿饭有人没喝酒，却被默认平均付款。你会？", [
      O("把差额算清楚，公平不等于所有人付一样", ["yang","ning"], {boundary:2, confrontation:1, stability:1}),
      O("金额不大就算了，别让结账破坏气氛", ["mao","chen"], {stability:2, confrontation:-1}),
      O("先问没喝的人介不介意，再决定怎么算", ["jing","xu"], {devotion:2, expression:1}),
      O("担心大家尴尬，我可能先垫付再慢慢处理", ["zheng","xu"], {devotion:2, stability:-1})]),
    ...
    Q("路上协作", "临时分组", "半天自由活动，大家想去的地方完全不同。你会？", [
      O("按兴趣分组，约好集合时间和紧急联系人", ["jing","yang"], {boundary:2, stability:2, initiative:1}),
    ...
    Q("关系升温", "旅行生日", "旅途中有人生日，但本人说不用特别安排。你会？", [
      ...
      O("会担心准备得不够好，最后包办很多细节", ["zheng","xu"], {devotion:2, stability:-1})]),
    Q("关系升温", "保守秘密", "同伴私下告诉你一件脆弱的往事。你会？", [
      O("明确告诉对方，未经允许不会向团队转述", ["yang","jing"], {boundary:2, devotion:2}),
    ...
    Q("关系升温", "照片发布", "朋友想发布一张你不喜欢的合照。你会？", [
      ...
      O("虽然介意，但怕扫兴可能先答应", ["zheng","xu"], {expression:-1, boundary:-2}),
    ...
    Q("关系升温", "想独处", "连续相处一周后，你很想一个人待半天。你会？", [
      ...
      O("担心别人觉得我不合群，可能继续陪着", ["zheng","xu"], {devotion:1, stability:-2, boundary:-1}),
    ...
    Q("关系升温", "借用物品", "同伴未经询问就用了你的东西。你会？", [
      ...
      O("关系好就不计较，东西本来就可以分享", ["chen","xu"], {devotion:1, boundary:-1}),
      O("嘴上说没事，心里却会反复觉得不被尊重", ["zheng","xu"], {expression:-1, stability:-2})]),
    Q("关系升温", "赞美落差", "大家都在夸一个人，你的付出却没人提起。你会？", [
      ...
      O("会很失落，希望亲近的人能主动看见", ["xu","zheng"], {expression:2, stability:-2}),
    ...
    Q("冲突现场", "花钱质疑", "有人公开质疑你花公共预算太随意。你会？", [
      O("拿出记录逐项核对，先解决事实争议", ["yang","jing"], {stability:2, confrontation:1}),
      O("当场问清楚对方凭什么这样评价", ["ning","xu"], {confrontation:2, expression:2}),
      O("先承认自己可能考虑不周，再补救", ["zheng","mao"], {devotion:2, stability:-1}),
      O("如果差额不大，我愿意自己承担让事情过去", ["chen","mao"], {boundary:-1, stability:1})]),
    Q("冲突现场", "语气刺人", "同伴说的事实没错，但语气让你很不舒服。你会？", [
      O("先回应事实，再说明我不接受这种表达方式", ["jing","yang"], {boundary:2, confrontation:2, stability:2}),
      O("立即回击，不能让锋利只落在我身上", ["ning","xu"], {confrontation:2, expression:2, stability:-1}),
      O("等双方冷静后私下谈，避免继续升级", ["mao","jing"], {stability:2, confrontation:1}),
      O("可能先怀疑是不是自己太敏感", ["zheng","xu"], {expression:-1, stability:-2})]),
    Q("冲突现场", "被要求站队", "两个朋友争吵，都要求你证明自己站在 TA 那边。你会？", [
      O("拒绝选人，只讨论具体行为和解决办法", ["jing","yang"], {boundary:2, stability:2}),
    ...
    Q("冲突现场", "房间太乱", "室友总把公共区域弄乱，你已经忍了几天。你会？", [
      ...
      O("自己收拾算了，争论比打扫更累", ["zheng","mao"], {devotion:2, boundary:-2}),
    ...
    Q("冲突现场", "承诺落空", "朋友答应帮你，却临时去参加别的活动。你会？", [
      ...
      O("很受伤，重点是对方没有把我放在心上", ["xu","zheng"], {expression:2, stability:-2}),
    ...
    Q("冲突现场", "传话失真", "你发现有人转述你的话时改变了原意。你会？", [
      ...
      O("先和信任的人确认，担心自己反应过度", ["xu","zheng"], {expression:1, stability:-1})]),
    Q("冲突现场", "冷战开始", "同伴突然不回应你，也不说明原因。你会？", [
      ...
      O("不断回想自己做错了什么，想先道歉", ["zheng","xu"], {devotion:1, stability:-2}),
    ...
    Q("压力测试", "护照遗失", "临近跨境交通时，有人发现护照不见了。你会？", [
      ...
      O("控制住责备，先问清对方能否承担下一步", ["ning","jing"], {confrontation:1, boundary:2}),
      O("不断安慰对方，避免 TA 因恐慌无法行动", ["xu","chen"], {expression:2, devotion:2})]),
    ...
    Q("压力测试", "自己发烧", "你开始发烧，但大家正期待当天的重头行程。你会？", [
      ...
      O("吃药再坚持，实在不行才告诉大家", ["yang","zheng"], {devotion:2, boundary:-2}),
    ...
    Q("压力测试", "现金不足", "偏远地区突然无法刷卡，团队现金不够。你会？", [
      ...
      O("会担心是谁算错了预算，但先不在此刻追责", ["zheng","xu"], {stability:-1, devotion:1})]),
    ...
    Q("压力测试", "工作打断", "同伴临时要处理工作，团队必须等待两小时。你会？", [
      ...
      O("陪对方一起等，怕 TA 一个人压力更大", ["xu","zheng"], {devotion:2, expression:1}),
      O("马上去探索周围，两小时也能有新体验", ["chen","ning"], {initiative:2, stability:1})]),
    Q("压力测试", "暴雨突袭", "户外行程遇到暴雨，有人仍坚持继续。你会？", [
      O("检查天气预警和撤离条件，再决定是否继续", ["jing","yang"], {stability:2, boundary:2}),
      O("安全没有讨价还价，直接要求返程", ["ning","mao"], {confrontation:2, boundary:2}),
      O("找到室内替代活动，不让一天完全报废", ["chen","zheng"], {initiative:2, stability:1}),
    ...
    Q("压力测试", "负责人倒下", "一直做决定的人突然崩溃，说自己什么都不想管。你会？", [
      ...
      O("会觉得自己也有责任，立刻多承担一些", ["zheng","xu"], {devotion:2, stability:-2})]),
    ...
    Q("旅程终章", "回家后的联系", "旅行结束一个月后，群聊逐渐安静。你会？", [
      ...
      O("担心是自己没维护好，会频繁在群里找话题", ["zheng","xu"], {devotion:2, stability:-2})]),
    ...
    Q("旅程终章", "旅程的意义", "多年后回想这段旅行，你最希望记住什么？", [
      ...
      O("我更清楚自己的边界、责任和位置", ["yang","jing"], {boundary:2, stability:1})])
  ];
})();
